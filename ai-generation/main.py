...
async def generate_quiz():
    quizOutput = openai.ChatCompletion.create(
        model="gpt-3.5-turbo",
        messages=[
            {
                'role': "system",
                "content": '''You are a quiz generator. Your role is to output a quiz from the given data in JSON format. The format should be like {"node":[{"question": <question>, "choices": [<choice>, <choice>...],"answer":<answer>}...]...}. Up to 4 choices for MCQs or True/False. The given data is'''
            },
            {
                "role": "user",
                "content": textbookData
